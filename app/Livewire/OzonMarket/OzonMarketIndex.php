...
class OzonMarketIndex extends BaseComponent
{
    ...
    {
        return $this->tapQuery($this->currentUser()->ozonMarkets()->select('ozon_markets.*', 'organizations.name AS organization_name')->leftJoin('organizations', 'ozon_markets.organization_id', '=', 'organizations.id'));
