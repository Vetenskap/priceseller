                    ...
                    <flux:rows>
                        @foreach($this->events as $event)
                            <flux:row :key="$event->getKey()">
                                ...
                                <flux:cell class="flex-1"><flux:textarea readonly resize="both">{{$event->event}}</flux:textarea></flux:cell>
                                <flux:cell class="flex-1"><flux:textarea readonly resize="both">{{$event->exception}}</flux:textarea></flux:cell>
                                <flux:cell class="flex-1">
                                    @if($report->itemable)
