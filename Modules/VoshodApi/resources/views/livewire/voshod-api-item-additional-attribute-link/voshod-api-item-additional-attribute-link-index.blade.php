<div>
    <x-layouts.main-container>
        ...
        <x-blocks.flex-block>
            ...
            <x-dropdowns.dropdown-select name="link"
                                         :items="\Modules\VoshodApi\HttpClient\Resources\Item::ATTRIBUTES"
                                         option-value="name"
                                         option-name="label"
    ...
    @if($voshodApi->itemAdditionalAttributeLinks->isNotEmpty())
        <x-layouts.main-container>
            <x-blocks.main-block>
            ...
            @foreach($voshodApi->itemAdditionalAttributeLinks as $link)
                <livewire:voshodapi::voshod-api-item-additional-attribute-link.voshod-api-item-additional-attribute-link-edit :voshodItemLink="$link"
            @endforeach
        </x-layouts.main-container>
    @endif
</div>
