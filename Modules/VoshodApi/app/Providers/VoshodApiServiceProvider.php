...
namespace Modules\VoshodApi\Providers;
...
{
    protected string $moduleName = 'VoshodApi';

    protected string $moduleNameLower = 'voshodapi';
        ...
        if (App::isProduction()) {
            $this->app->booted(function () {
                ...
                $schedule->call(function () {
                    VoshodUserProcessService::processUsers();
                })->name('VoshodApiEveryMinuteSchedule')->everyMinute()->withoutOverlapping();
            });
        }
    }
