        ...
        <x-blocks.main-block>
            @if($this->markets->count() > 0)
                <flux:table :paginate="$this->markets">
                    <flux:columns>
                        <flux:column sortable :sorted="$sortBy === 'wb_markets.name'" :direction="$sortDirection"
                                     wire:click="sort('wb_markets.name')">Кабинет
                        </flux:column>
                        ...
                        <flux:column sortable :sorted="$sortBy === 'wb_markets.updated_at'" :direction="$sortDirection"
                                     wire:click="sort('wb_markets.updated_at')">Последнее обновление
                        </flux:column>
                    </flux:columns>
