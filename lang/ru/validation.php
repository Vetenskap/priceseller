...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'brand' => 'Бренд поставщика',
        'ms_uuid' => 'UUID Мой Склад',
        'multiplicity' => 'Кратность отгрузки',
        'unload_ozon' => 'Выгружать на ОЗОН',
        'unload_wb' => 'Выгружать на ВБ',
        'buy_price_reserve' => 'Закупочная цена резерв',
    ],
